    let url1 = `http://api.weatherapi.com/v1/current.json?key=527619bad6e54defbe870545241106&q=new york`;
	let url2 = `http://api.weatherapi.com/v1/current.json?key=527619bad6e54defbe870545241106&q=sydney`;
	let url3 = `http://api.weatherapi.com/v1/current.json?key=527619bad6e54defbe870545241106&q=Jakarta`;
	let url4 = `http://api.weatherapi.com/v1/current.json?key=527619bad6e54defbe870545241106&q=shanghai`;
	let url5 = `http://api.weatherapi.com/v1/current.json?key=527619bad6e54defbe870545241106&q=Toronto`;
	let url6 = `http://api.weatherapi.com/v1/current.json?key=527619bad6e54defbe870545241106&q=Lahore`;
